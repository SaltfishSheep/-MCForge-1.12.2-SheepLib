...
public class MethodEditor {
    ...
    public static void pushField(MethodVisitor mv, String classEdited, String fieldName, String fieldType){
        classEdited = classEdited.replace('.','/');
        mv.visitFieldInsn(Opcodes.GETSTATIC, classEdited, fieldName, DescriptorUtils.getFieldDescriptor(fieldType));
    }
